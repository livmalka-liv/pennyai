...
const CHAPTERS: Chapter[] = [
  {
    ...
    text: "שלום, אני פני. בוא ניקח שתי דקות ביחד. אני אראה לך מה יש פה, איך זה עובד, ולמה זה שונה. בלי הרצאות — פשוט עוברים על המסך. בסדר? יאלה.",
    mockup: (
  ...
  },
  {
    ...
    text: "אז זה ה-Sandbox. אני כותב בצ'אט: VWAP Reclaim, פלואט עד 20 מיליון. לוחץ Enter. המערכת מריצה את זה על 15 שנה של נתונים אמיתיים. תוך שניות — תוצאות. 67 אחוז הצלחה. רווח נטו חיובי. מקסימום ירידה 18 אחוז. לא ניחוש — נתונים. רק אחרי שמשהו עובר פה, הוא עובר הלאה.",
  ...
  },
  {
    ...
    text: "עכשיו Live Lab. שלוש עמודות — בואו נתחיל משמאל. כאן האסטרטגיות שלי. לכל אחת יש מתג. לוחץ — היא חיה. VWAP Reclaim — 71 אחוז הצלחה. 347 דולר רווח מצטבר. זה לא כסף אמיתי עדיין — זה על נייר. אבל הנתונים? לגמרי אמיתיים. בחינם יש 3 אסטרטגיות. ב-Starter — 15.",
    mockup: (
  ...
  },
  {
    ...
    text: "עמודה אמצע — הסיגנלים החיים. כל מניה שנמצאה מגיעה לפה. תראה — FFIE. פלואט 3 מיליון. זה אומר מניה קטנה שיכולה לקפוץ 20, 30 אחוז. RVOL פי 12 — ענק. כניסה 94 סנט, יעד 1.10. והיא כרגע פתוחה — 17 אחוז רווח. רואה את הירוק? זה בזמן אמת.",
    mockup: (
      <div className="space-y-1.5">
  ...
  },
  {
    ...
    text: "עמודה ימין — ה-AI Optimizer. הוא ניתח את כל העסקאות ומצא משהו. בין 4 ל-5 אחר הצהריים שלנו — Win Rate קופץ ל-73 אחוז. זה לא מקרי — זה הזמן שהשוק האמריקאי עובר שעה ויש נפח חזק. ההמלצה שלו: תגביל כניסות לשעה הזאת. הוא רץ אוטומטי כל שבוע ובודק מחדש.",
  ...
  },
  {
    ...
    text: "אז איך בכלל מגיעים הסיגנלים? יש סורק שרץ על השרת שלנו — לא על המחשב שלך. אפשר לסגור את הדפדפן, הוא ממשיך לעבוד. מחובר ל-Polygon.io, עדכון כל שנייה. 200 מניות במקביל. מניה עולה 10 אחוז? RVOL מעל 6? פלואט מתחת ל-10 מיליון? הוא מזהה ומכניס סיגנל אוטומטי.",
    mockup: <MockScanner />,
    durationMs: 16000,
  },
  {
    ...
    text: "ועוד דבר אחד — הקורס. אחרי שאסטרטגיה עושה 20 עסקאות מעל 55 אחוז הצלחה, מופיע כפתור: בנה קורס AI. לוחצים. תוך כמה שניות יש לך קורס מותאם לחשבון שלך. לא יוטיוב גנרי. הוא אומר לך בדיוק — ב-VWAP Reclaim, בשעה 4 אחר הצהריים, אצלך ספציפית, ההצלחה היא 68 אחוז. למה. ואיך לשפר.",
    mockup: <MockCourse />,
    durationMs: 16000,
  },
  {
    ...
    text: "אז מה עושים עכשיו? נכנסים ל-Sandbox. כותבים אסטרטגיה. מריצים בדיקה. אם זה עובד — שולחים ל-Live Lab. שלוש האסטרטגיות הראשונות חינם לגמרי. אין כרטיס אשראי. רוצה יותר — Starter ב-59 שקל. רוצה הכל כולל ביצוע אמיתי — Pro ב-149. זהו. מחכה לך בפנים.",
    mockup: (
